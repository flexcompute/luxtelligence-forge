...
def chip_frame(
    *,
    x_size: pft.annotate(Literal[5000, 5050, 10000, 10100, 20000, 20200], units="μm") = 10_000,
    y_size: pft.annotate(Literal[5000, 5050, 10000, 10100, 20000, 20200], units="μm") = 5_000,
