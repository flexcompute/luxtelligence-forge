...
descriptions = {
    (2, 10): "LT etch (ridge)",
    (2, 11): "LT etch (ridge, periodic features)",
    (3, 10): "LT etch (full)",
    (3, 11): "Slab etch negative",
    (4, 0): "Labels (LT etch)",
    (6, 0): "Usable floorplan area",
    (6, 1): "Final chip boundaries",
    (20, 0): "Metal 1",
    (22, 0): "Metal 2",
    (23, 0): "High resistivity metal",
    (40, 0): "Via between M1 and M2",
    (41, 0): "Via between M2 and HRL",
    (50, 1): "Error markers",
...
if __name__ == "__main__":
    ...
    output = pathlib.Path(__file__).parent / "luxtelligence_ltoi300_forge" / "_layers.py"
    output.write_text("\n".join(lines))
